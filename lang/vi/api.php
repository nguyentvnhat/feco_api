...
return [
    ...
    'order' => [
        ...
        'history_commission_success' => 'Lấy lịch sử hoa hồng thành công.',
        'history_commission_no_agent_profile' => 'Tài khoản chưa có hồ sơ đại lý để xem hoa hồng.',
        'history_discount_success' => 'Lấy lịch sử chiết khấu thành công.',
        'history_discount_no_agent_profile' => 'Tài khoản chưa có hồ sơ đại lý để xem chiết khấu.',
